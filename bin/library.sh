...
export syncer_anvil_firehose_log="$syncer_anvil_data_dir/syncer_anvil.firelog"
...
export syncer_geth_firehose_log="$syncer_geth_data_dir/syncer_geth.firelog"
...
export syncer_erigon_firehose_log="$syncer_erigon_data_dir/syncer_erigon.firelog"
