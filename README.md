...
| Polygon (fh 2.3) | docker miner: `./scripts/polygon/up.sh 2.3 -c`, then `./scripts/run_firehose_polygon.sh 2.3` | `pnpm test:fh2.3:polygon-dev` | |
| Polygon (fh 3.0) | docker miner: `./scripts/polygon/up.sh 3.0 -c`, then `./scripts/run_firehose_polygon.sh 3.0` | `pnpm test:fh3.0:polygon-dev` | |
