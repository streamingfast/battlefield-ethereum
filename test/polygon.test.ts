...
if (isNetwork("polygon-dev")) {
  describe("Polygon", function () {
    ...
    it("Polygon ETH Transfer Logs", async function () {
      ...
      expect(receiptLog2.data.slice(0, 32)).to.deep.equal(Buffer.from("00000000000000000000000000000000000000000000000000035b78f54b4188", "hex"))
      ...
      expect(log2.data.slice(0, 32)).to.deep.equal(Buffer.from("00000000000000000000000000000000000000000000000000035b78f54b4188", "hex"))
