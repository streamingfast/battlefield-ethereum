...
async function main() {
  ...
  console.log(` Default address: ${getDefaultAddress()}`)
  ...
  //   const mainDeployment = await deployContractRaw(web3, getDefaultAddress(), privateKey, "Main")
  ...
  const mainDeployment = {
    contractAddress: "0x1F7107a4C9C94125e357ad9a9Be523FB24c8a7ef",
    transactionHash: "0xbd10cc23596d8ef39ed8daab9d327d511018fc6e59cae4930fb6c8613e430d6e"
  }
  ...
  console.log(mainContract.jsonInterface)
  const result = await mainContract.methods.setLongString().call()
